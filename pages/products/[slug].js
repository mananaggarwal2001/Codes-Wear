          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button onClick={() => buyNow(slug, 1, 499, `(${product.title}(${product.size}/${product.color})`, 'XL', 'Red')} className="flex items-center justify-center ml-8 text-white md:text-base font-bold text-xs bg-pink-500 border-0 py-2 md:px-6 px-2 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
                <button onClick={() => { addToCart(slug, 1, 499,`(${product.title}(${product.size}/${product.color})`, 'XL', 'Red') }} className="flex items-center justify-center ml-3 text-white md:text-base font-bold text-xs bg-pink-500 border-0 py-2 md:px-6 px-2 focus:outline-none hover:bg-pink-600 rounded">Add To Cart</button>
